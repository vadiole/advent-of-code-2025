...
fun main() {
    ...
    val top3Circuits = circuits.sortedByDescending { it.size }.take(3)
    val multipliedSizes = top3Circuits.map { it.size }.reduce { acc, size -> acc * size }
    println("output: $multipliedSizes")
}
